...
from app.schemas.common import DMYDate
...
class InteractionExtraction(BaseModel):
    ...
    interaction_date: DMYDate = Field(description="The date of the interaction. If not explicitly mentioned, assume today's date in DD-MM-YYYY format.")
    ...
    follow_up_date: Optional[DMYDate] = Field(default=None, description="The date the follow up should occur, if requested in DD-MM-YYYY format.")
...
class InteractionEditExtraction(BaseModel):
    ...
    interaction_date: Optional[DMYDate] = Field(default=None, description="The new date of the interaction in DD-MM-YYYY format.")
    ...
    follow_up_date: Optional[DMYDate] = Field(default=None, description="The updated follow-up date in DD-MM-YYYY format — only if user asked to change it.")
